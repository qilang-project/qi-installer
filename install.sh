...
if command -v qi &> /dev/null; then
    ...
    echo ""
    print_info "使用方法:"
    print_info "  qi run <文件.qi>       - 运行奇语言程序"
    print_info "  qi compile <文件.qi>   - 编译奇语言程序"
    print_info "  qi check <文件.qi>     - 检查语法"
    print_info "  qi --help              - 查看帮助"
    echo ""
    print_success "现在你可以在任何地方使用 'qi' 命令了！"
else
